...
define('CRM_LOGIN', 'karlova.catia@yandex.ru'); // логин пользователя CRM по управлению лидами
define('CRM_PASSWORD', 'kosmosura90'); // пароль пользователя CRM по управлению лидами
